from PyQt5.Qsci import QsciAPIs, QsciLexerJavaScript, QsciScintilla
from PyQt5.QtCore import Qt
from PyQt5.QtGui import QColor, QFont, QKeyEvent
from utils.keywords import js_keywords


class JavaScriptEditorTextArea(QsciScintilla):
    def __init__(self):
        super().__init__()
        self.font = QFont("Consolas", 15)
        self.setFont(self.font)

        self.keyword = js_keywords
