...
from utils.keywords import python_keywords


class PythonEditorTextArea(QsciScintilla):
    ...
    def apply_theme(self, lex):
        ...
        lex.setColor(QColor("#E5C07B"), 8)
        lex.setColor(QColor("#61AFEF"), 9)
        lex.setFont(QFont("Consolas", 15, QFont.Bold), 9)
        lex.setColor(QColor("#98C379"), 3)
        lex.setColor(QColor("#98C379"), 4)
        lex.setColor(QColor("#98C379"), 6)
        lex.setColor(QColor("#98C379"), 7)
        lex.setColor(QColor("#98C379"), 17)
        lex.setColor(QColor("#98C379"), 16)
        lex.setColor(QColor("#98C379"), 18)
        lex.setColor(QColor("#98C379"), 19)
        lex.setColor(QColor("#D19A66"), 2)
        lex.setColor(QColor("#E06C75"), 11)
        lex.setColor(QColor("#7F848E"), 12)
        lex.setColor(QColor("#61AFEF"), 15)
        lex.setColor(QColor("#E06C75"), 0)
